        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0" style="background-color: rgb(0,101,46);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <c:if test="${utilisateur.getRole()==\"Eboueur\"}">
                    ...
                    <c:if test="${utilisateur.getRole()==\"Admin\"}">
                    	<li class="nav-item" role="presentation"><a class="nav-link" href="liste_utilisateurs"><i class="fas fa-user"></i><span>Listes des utilisatuers</span></a></li>
                    </c:if>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="logout"><i class="fas fa-sign-out-alt fa-fw" style="font-size: 21px;color: rgb(255,15,0);"></i></a>
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">Wilfried SOUMAGNIN</span><img class="border rounded-circle img-profile" src="assets/img/2ab3d48d13328872.jpg"></a>
                                    <div
            ...
            <div class="container-fluid">
                <div class="text-center mt-5">
                    ...
                    <p class="text-dark mb-5 lead">Page Not Found</p><a href="/">← Back to Dashboard</a></div>
            </div>
        </div>
