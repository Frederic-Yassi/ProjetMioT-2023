    ...
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <c:if test="${utilisateur.getRole()==\"Admin\" }">
                    	<li class="nav-item" role="presentation"><a class="nav-link" href="ajout_poubelles"><i class="fas fa-user-circle"></i><span>Ajouter une poubelle</span></a></li>
                    </c:if>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Ajout d'une poubelle</h3>
                <div class="row mb-3">
                    <div class="col-lg-4">
           				<div class="card mb-3">
    						<div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/poubelle.png" width="160" height="160" /></div>
						</div>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="m-0 font-weight-bold" style="color: rgb(0,101,46);">Trash Settings</p>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="adresse_poubelle"><strong>Adresse</strong><br></label><input class="form-control" type="text" placeholder="" id="adresse_poubelle" name="adresse_poubelle" value="<c:out value="${trash_a_modifier.getAdresse()}"/>"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="etat_poubelle"><strong>Etat</strong><br></label><input class="form-control" type="text" placeholder="" id="etat_poubelle" name="etat_poubelle" value="${trash_a_modifier.getState()}"/></div>
                                                </div>
                                            </div>
                                            
                                            
                                            <c:out value="${trash_a_modifier.getAdresse()}"/>
                                            <c:if test="${ajout!=\"true\"}">
                                            	 <a class="btn btn-primary float-right" role="button" onclick="save_modification_trash('<c:out value="${trash_a_modifier.getAdresse()}"/>')" style="background-color: rgb(0,101,46);">Enregistrer</a>
                                            </c:if>
                                            <c:if test="${ajout==\"true\"}">
                                            	 <a class="btn btn-primary float-right" role="button" onclick="save_new_trash()" style="background-color: rgb(0,101,46);">Ajouter</a>
                                            </c:if>
                                        </form>
                                    </div>
                                </div>
